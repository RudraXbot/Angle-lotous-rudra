...
OWNER_ID = int(getenv("OWNER_ID", 6604753875))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+kt_KU1TAnTQzNjI0")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/sinaxchatgroup")
